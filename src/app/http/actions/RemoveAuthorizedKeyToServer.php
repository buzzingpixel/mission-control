...
class RemoveAuthorizedKeyToServer
{
    ...
    public function __invoke() : ResponseInterface
    {
        if ($this->requestHelper->method() !== 'post') {
            throw new LogicException(
                'Remove Authorized Key to Server requires post request'
            );
        }
        ...
        $this->serverApi->removeServerAuthorizedKey($key, $server);
        ...
        $flashDataModel->dataItem(
            'content',
            'Authorized key removed successfully!'
        );
